...
// scoreboard
let playerScores = []
const shootAudio = new Audio('./code/sounds/shoot.wav')
const explosionAudio = new Audio('./code/sounds/explosion.wav')
const invaderKilledAudio = new Audio('./code/sounds/invaderkilled.wav')
const gamePlayAudio = new Audio('./code/sounds/spaceinvaders1.mpeg')
